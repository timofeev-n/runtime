...
CoreTaskPtr createCoreTask(Runtime::Allocator::Ptr, Args&& ... args);
...
private:
	...
	static CoreTaskPtr create(ComPtr<Allocator>, size_t, StateDestructorCallback);
...
private:
	...
	template<typename T>
	friend struct AsyncDetail::RvTaskAwaiter;

	template<typename T>
	friend struct AsyncDetail::LvTaskAwaiter;
};

...
//	boost::optional<ResponseStatus> status() const;

//	boost::optional<RequestData> requestData() const;
...
private:
	...
	mutable boost::optional<size_t> m_contentLength;
};
...
inline auto begin(const Runtime::HttpParser& parser)
{
	return parser.begin();
}

inline auto end(const Runtime::HttpParser& parser)
{
	return parser.end();
}

//inline auto begin(const Runtime::HttpParser::Path& path)
//{
//	return path.begin();
//}
//
//inline auto end(const Runtime::HttpParser::Path& path)
//{
//	return path.end();
//}
//
//inline auto begin(const Runtime::HttpParser::Arguments& args)
//{
//	return args.begin();
//}
//
//inline auto end(const Runtime::HttpParser::Arguments& args)
//{
//	return args.end();
//}

...
//#define RUNTIME_THREADING_EVENT_FORCE_STDLIB

#if defined(RUNTIME_THREADING_EVENT_FORCE_STDLIB) || !defined(_WIN32)
#define RUNTIME_THREADING_EVENT_STDLIB
#elif defined(_WIN32)
#define RUNTIME_THREADING_EVENT_WINAPI
#endif
...
#ifdef RUNTIME_THREADING_EVENT_WINAPI
	~Event();
#endif
...
#ifdef RUNTIME_THREADING_EVENT_STDLIB
	std::mutex m_mutex;
	std::condition_variable m_signal;
	bool m_state;
#elif defined (RUNTIME_THREADING_EVENT_WINAPI)
	void* const m_event;
#endif
};

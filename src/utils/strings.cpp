...
{
	return StringsDetail::trimEnd_(str);
}
...
{
	return StringsDetail::trimStart_(str);
}
...
{
	return StringsDetail::trim_(str);
}
...
{
	return StringsDetail::endWith_(str, value);
}
...
{
	return StringsDetail::startWith_(str, value);
}
